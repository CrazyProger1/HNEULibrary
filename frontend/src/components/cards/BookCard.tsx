...
const BookCard: FC<BookCardProps> = ({title, authorName, authorLastName}) => {
    return (
        <div
            className="w-64 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
                 src="/src/assets/bibliosity.jpg" alt=""/>
            <a href="#">
